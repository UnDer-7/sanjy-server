...
public record MealRecordStatisticsResponseDTO(
    ...
    @Schema(
        description = "Quantity of planned meal records (following the diet plan) consumed within the specified date range",
        example = "15",
        requiredMode = Schema.RequiredMode.REQUIRED
    )
    ...
    @Schema(
        description = "Total quantity of meal records (both free and planned) consumed within the specified date range",
        example = "20",
        requiredMode = Schema.RequiredMode.REQUIRED
    )
    Long mealQuantity
