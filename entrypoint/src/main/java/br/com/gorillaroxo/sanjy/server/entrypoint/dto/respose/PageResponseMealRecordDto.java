 ...
 *
 * <p>This class exists solely to work around a limitation in Swagger/OpenAPI with generic types.
 * While it would be ideal to return {@code PageResponseDto<MealRecordResponseDto>} directly from
 * controllers, Swagger cannot properly render generic response types in the documentation.
 * Without this concrete class, the Swagger UI would show an incorrect or broken response schema.
 *
 * <p><b>Why this is necessary:</b>
 *
 * <ul>
 *   <li>Swagger generates unhelpful schema names for generic types (e.g.,
 *       "PageResponseDtoMealRecordResponseDto")
 ...
 *
 * <p>Create a concrete class that extends the generic parent. This allows Swagger to correctly
 * identify and document the response structure with proper type information for the {@code
 * content} field.
 *
