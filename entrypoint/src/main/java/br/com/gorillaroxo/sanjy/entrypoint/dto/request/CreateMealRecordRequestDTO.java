...
public record CreateMealRecordRequestDTO(
    ...
    @Schema(
        description = "ID of the chosen diet plan option. Required when isFreeMeal = FALSE, should be NULL when isFreeMeal = TRUE",
        example = "5",
        nullable = true,
        requiredMode = Schema.RequiredMode.NOT_REQUIRED
    )
    ...
    @Schema(
        description = "Text description of the free meal item. Required when isFreeMeal = TRUE, should be NULL when isFreeMeal = FALSE",
