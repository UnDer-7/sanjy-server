...
public interface MealRecordRestService {
                    ...
                    @io.swagger.v3.oas.annotations.parameters.RequestBody(
                            content =
                                    @Content(
                                            ...
                                            examples = {
                                                @ExampleObject(name = """
                                                            Record a meal not listed in the diet plan (e.g., snacks, unplanned meals)
                                                            """, summary = "Free meal record", value = """
                         {
                             "mealTypeId": 1,
                        ...
                        """),
                                                @ExampleObject(name = """
                                                            Record a meal from a standard option defined in the diet plan
                                                            """, summary = "Planned meal record", value = """
                         {
                             "mealTypeId": 1,
                             "consumedAt": "2025-11-14T10:34:55Z",
                             "isFreeMeal": false,
    ...
    @ApiResponse(
            ...
            content =
                    @Content(
                        ...
                        """),
                                @ExampleObject(name = "No meals recorded today", summary = "Empty result", value = "[]")
                            }))
    ...
    @ApiResponse(
            ...
            content = @Content(schema = @Schema(implementation = PageResponseMealRecordDto.class)))
    @ApiResponse(
            responseCode = OpenApiConstants.HttpStatusCodes.OK,
            description = "Today's meal records",
            content =
