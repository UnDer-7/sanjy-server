...
public record DietPlanCompleteResponseDTO(
    ...
    @Schema(description = "Date when this diet plan starts",
        example = "2025-01-15",
        format = "yyyy-MM-dd",
        requiredMode = Schema.RequiredMode.REQUIRED)
    LocalDate startDate,

    @Schema(description = "Date when this diet plan ends",
        example = "2025-04-15",
        requiredMode = Schema.RequiredMode.REQUIRED)
    LocalDate endDate,
    ...
    @Schema(description = "Timestamp when this diet plan was created",
