...
class MealRecordControllerIT extends IntegrationTestController {
    ...
    void newMealRecord__should_successfully_create_planned_mealRecord() {
        final MealTypeEntity mealType = dietPlan.getMealTypes().stream().findFirst().orElseThrow();
        final StandardOptionEntity standardOption = mealType.getStandardOptions().stream().findFirst().orElseThrow();
    ...
    void searchMealRecords__should_return_four_mealRecords() {
        ...
        List.of(requestPlannedMealRecord0, requestPlannedMealRecord1, requestPlannedMealRecord2, requestFreeMealRecord1, requestFreeMealRecord2)
        ...
        webTestClient
            ...
            .uri(uriBuilder -> uriBuilder
                ...
                .queryParam(RequestConstants.Query.CONSUMED_AT_AFTER, LocalDate.now().atStartOfDay())
                .build())
            .header(RequestConstants.Headers.X_CORRELATION_ID, "bf5ef8a2-5af2-4adf-8b58-d186fe01cd11")
            .header(RequestConstants.Headers.X_CHANNEL, "integration-test")
            .exchange()
    ...
    void getMealRecordStatisticsByDateRange__should_successfully_return_statistics() {
        ...
        webTestClient
            ...
            .uri(uriBuilder -> uriBuilder
                ...
                .queryParam(RequestConstants.Query.CONSUMED_AT_BEFORE, LocalDateTime.of(currentDate, LocalTime.MAX))
                .build())
            .header(RequestConstants.Headers.X_CORRELATION_ID, "bf5ef8a2-5af2-4adf-8b58-d186fe01cd11")
            .header(RequestConstants.Headers.X_CHANNEL, "integration-test")
            .exchange()
