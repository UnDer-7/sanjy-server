...
/**
 * Base class for integration tests. Uses WebTestClient which is compatible with both JVM and GraalVM Native Image modes.
 */
@Slf4j
...
public abstract class IntegrationTestController {
    ...
    protected final DietPlanEntity createDietPlan() {
        final var standardOption = EntityBuilders.buildStandardOptionEntity()
            .id(null)
            .build();
