...
import br.com.gorillaroxo.sanjy.entrypoint.dto.request.CreateStandardOptionRequestDTO;
...
public interface StandardOptionMapper {
    ...
    Set<StandardOptionDomain> toDomainListFromStandardOptionEntity(Set<StandardOptionEntity> entity);
    ...
    Set<StandardOptionDomain> toDomainSetFromCreateStandardOptionRequestDTO(Set<CreateStandardOptionRequestDTO> dto);
