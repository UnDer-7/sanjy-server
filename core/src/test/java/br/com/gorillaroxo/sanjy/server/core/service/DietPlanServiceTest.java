...
class DietPlanServiceTest {
    ...
    void should_fail_when_passing_repeated_meal_type_names(final List<MealTypeDomain> mealTypes, final List<String> expectedErrorMessages) {
        // Given
        final DietPlanDomain dietPlan = DomainBuilder.buildDietPlanDomain()
            .mealTypes(mealTypes)
            .build();
        ...
        // Then
        abstractThrowableAssert.isInstanceOf(RepeatedMealTypeNamesException.class)
    ...
    static Stream<Arguments> testSuite_should_fail_when_passing_repeated_meal_type_names() {
        return Stream.of(
            Arguments.of(
                List.of(
                    DomainBuilder.buildMealTypeDomain().name("Breakfast").build(),
                    DomainBuilder.buildMealTypeDomain().name("Jantar").build(),
                    DomainBuilder.buildMealTypeDomain().name("breakfast").build()),
                List.of("breakfast")),
            Arguments.of(
                List.of(
                    DomainBuilder.buildMealTypeDomain().name("lunch").build(),
                    DomainBuilder.buildMealTypeDomain().name("Lunch").build(),
                    DomainBuilder.buildMealTypeDomain().name("Breakfast").build()),
                List.of("lunch")),
            Arguments.of(
                List.of(
                    DomainBuilder.buildMealTypeDomain().name("brunch").build(),
                    DomainBuilder.buildMealTypeDomain().name("BRUNCH").build(),
                    DomainBuilder.buildMealTypeDomain().name("Breakfast").build()),
                List.of("brunch")),
            Arguments.of(
            ...
            Arguments.of(
                List.of(
                    DomainBuilder.buildMealTypeDomain().name("dinner").build(),
                    DomainBuilder.buildMealTypeDomain().name("dinner").build(),
                    DomainBuilder.buildMealTypeDomain().name("Breakfast").build(),
                    DomainBuilder.buildMealTypeDomain().name("lunch").build(),
                    DomainBuilder.buildMealTypeDomain().name("Lunch").build()),
