...
public class GetMealRecordStatisticsUseCaseImpl implements GetMealRecordStatisticsUseCase {
    ...
    @Override
    public MealRecordStatisticsDomain execute(final LocalDateTime consumedAtAfter, final LocalDateTime consumedAtBefore) {
        log.info(
        ...
        final MealRecordStatisticsDomain mealRecordStatistics = mealRecordGateway.getMealRecordStatisticsByDateRange(consumedAtAfter,
                consumedAtBefore)
        ...
        log.info(
            ...
            StructuredArguments.kv(LogField.PLANNED_MEAL_QUANTITY.label(), mealRecordStatistics.plannedMealQuantity()),
