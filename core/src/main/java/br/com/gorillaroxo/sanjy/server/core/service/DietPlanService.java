...
public class DietPlanService {
    ...
    public DietPlanDomain insert(final DietPlanDomain newDietPlan) {
        log.info(
            ...
            StructuredArguments.kv(LogField.DIET_PLAN_MEAL_TYPE_SIZE.label(), newDietPlan.getMealTypes().size()));
        ...
        dietPlanGateway.findActive()
            .ifPresent(dietPlanFound -> {
                log.info(
                    ...
                    StructuredArguments.kv(LogField.DIET_PLAN_MEAL_TYPE_SIZE.label(), dietPlanFound.getMealTypes().size()));
        ...
        log.info(
            ...
            StructuredArguments.kv(LogField.DIET_PLAN_MEAL_TYPE_SIZE.label(), dietPlanCreated.getMealTypes().size()));

        return dietPlanCreated;
    }

    private static void validateMealType(final DietPlanDomain newDietPlan) {
        final List<String> repeatedMealTypeNames = newDietPlan.getMealTypes()
            .stream()
